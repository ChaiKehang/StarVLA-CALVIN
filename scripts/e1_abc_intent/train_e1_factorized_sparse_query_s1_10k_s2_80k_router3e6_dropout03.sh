#!/usr/bin/env bash
# Factorized main run with conservative Query-FiLM:
# S1 10k + S2 80k, router LR 3e-6, condition dropout 0.3.
...
export CONFIG_YAML="${CONFIG_YAML:-${STARVLA_DIR}/examples/calvin/train_files/e1_factorized_sparse_query_s1_10k_s2_80k_router3e6_dropout03.yaml}"
...
export RUN_ID="${RUN_ID:-e1_factorized_sparse_query_s1_10k_s2_80k_router3e6_dropout03}"
